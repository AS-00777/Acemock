...
export const LANGUAGES = ['English', 'Spanish', 'French', 'German', 'Hindi', 'Japanese'];
export const EXPERIENCE_LEVELS = ['Fresher', '1–3 yrs', '3+ yrs'];
export const JOB_SEEKER_EXPERIENCE = ['Fresher', '1–3 Years', '3–5 Years', '5+ Years'];
export const USER_TYPES = ['Student', 'Working Professional', 'Job Seeker'] as const;
export const EDUCATION_LEVELS = ['High School', 'Bachelor\'s Degree', 'Master\'s Degree', 'PhD', 'Bootcamp / Certification'];

export const INTERVIEW_MODES = ['Text', 'Voice'];
...
export const LOCATION_DATA: Record<string, string[]> = {
  'India': ['Mumbai', 'Delhi', 'Bangalore', 'Hyderabad', 'Pune', 'Chennai', 'Kolkata'],
  'USA': ['New York', 'San Francisco', 'Chicago', 'Austin', 'Seattle', 'Los Angeles'],
...
export const Icons = {
  ...
  CloudUpload: () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M12 12v9"/><path d="m8 16 4-4 4 4"/></svg>
  ),
  Replay: () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 5L6 9H2v6h4l5 4V5z"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/></svg>
  ),
  Trash: () => (
  ...
  Globe: () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/></svg>
  ),
  Settings: () => (
