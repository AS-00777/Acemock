...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    return (
      ...
      >
        ...
        <span className={`text-[13px] font-bold tracking-tight ${
          ...
          : 'text-slate-500 dark:text-neutral-400 group-hover:text-blue-600 dark:group-hover:text-blue-400'
        }`}>
          {label}
        </span>
        {isActive && (
    ...
    return (
      <Link 
        ...
        className={`flex items-center gap-4 px-6 py-3.5 rounded-2xl transition-all duration-200 ${
          isActive
            ? 'text-slate-900 dark:text-neutral-100 bg-slate-50 dark:bg-neutral-800/50'
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50/30 dark:bg-neutral-950 transition-colors duration-200">
      ...
      <aside className={`fixed top-0 left-0 bottom-0 z-[70] w-72 bg-white dark:bg-neutral-900 shadow-2xl transform transition-transform duration-300 ease-out md:hidden ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-slate-100 dark:border-neutral-800 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="font-black text-slate-900 dark:text-neutral-100 uppercase tracking-tighter">AceMock</span>
            </div>
          ...
          <div className="flex-grow p-4 space-y-1 overflow-y-auto">
            ...
            {profile && (
              <>
                ...
                <div className="px-6 pt-4 pb-1 text-[10px] font-black text-slate-400 dark:text-neutral-400 uppercase tracking-widest">Practice</div>
                ...
                <div className="px-6 pt-4 pb-1 text-[10px] font-black text-slate-400 dark:text-neutral-400 uppercase tracking-widest text-center mt-4">Subscription</div>
      ...
      {/* Navbar */}
      <nav className="bg-white/90 dark:bg-neutral-900/90 backdrop-blur-xl border-b border-slate-100 dark:border-neutral-800 sticky top-0 z-50 h-20 flex items-center shadow-sm shadow-slate-200/20 dark:shadow-slate-950/20 transition-colors duration-200">
          ...
          <div className="flex items-center gap-4 md:gap-8">
            ...
            <div className="md:hidden">
              <button 
                ...
                className="p-2 -ml-2 text-slate-500 dark:text-neutral-400 hover:bg-slate-50 dark:hover:bg-neutral-800 rounded-xl transition-colors"
              >
            ...
            <Link to="/" className="flex items-center gap-3 group">
              ...
              <span className="text-xl font-black tracking-tighter text-slate-900 dark:text-neutral-100 font-poppins uppercase">AceMock</span>
            </Link>
          </div>
              ...
              {profile ? (
                ...
                <div className="relative" ref={guestDropdownRef}>
                  <button 
                    ...
                    className="flex items-center justify-center p-2 rounded-xl text-slate-500 dark:text-neutral-400 hover:bg-slate-50 dark:hover:bg-neutral-800 transition-all border border-transparent hover:border-slate-100 dark:hover:border-slate-700"
                  >
                  ...
                  {isGuestDropdownOpen && (
                    <div className="absolute right-0 mt-3 w-48 bg-white dark:bg-neutral-900 rounded-2xl shadow-2xl border border-slate-100 dark:border-neutral-800 p-2 z-[100] animate-in zoom-in-95 duration-200">
                      <Link to="/login" className="block w-full text-left px-4 py-3 rounded-xl text-sm font-bold text-slate-700 dark:text-neutral-200 hover:bg-slate-50 dark:hover:bg-neutral-800">Login</Link>
      ...
      <footer className="bg-white dark:bg-neutral-900 border-t border-slate-100 dark:border-neutral-800 py-16 mt-20 transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-slate-500 dark:text-neutral-400 max-w-sm text-base leading-relaxed font-medium">
          ...
          <div>
            <h4 className="font-black mb-6 text-slate-900 dark:text-neutral-100 uppercase text-[10px] tracking-[0.2em]">Navigation</h4>
            <ul className="space-y-4 text-slate-500 dark:text-neutral-400 font-bold text-sm">
          ...
          <div>
            <h4 className="font-black mb-6 text-slate-900 dark:text-neutral-100 uppercase text-[10px] tracking-[0.2em]">Company</h4>
            <ul className="space-y-4 text-slate-500 dark:text-neutral-400 font-bold text-sm">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center mt-16 pt-8 border-t border-slate-50 dark:border-neutral-800 text-slate-400 dark:text-neutral-400 text-[10px] font-black uppercase tracking-[0.4em]">
