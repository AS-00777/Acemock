  ...
  return (
    <Layout>
      <div className="relative overflow-hidden transition-colors duration-200">
        {/* Background Decor */}
        <div className="absolute top-0 right-0 -z-10 w-[600px] h-[600px] bg-blue-50 dark:bg-blue-900/10 rounded-full blur-3xl opacity-60 translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute bottom-0 left-0 -z-10 w-[400px] h-[400px] bg-purple-50 dark:bg-purple-900/10 rounded-full blur-3xl opacity-40 -translate-x-1/2 translate-y-1/2"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-gray-900 dark:text-slate-100 mb-6 leading-tight tracking-tight">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            ...
            <Link 
              ...
              className="w-full sm:w-auto px-8 py-4 bg-white dark:bg-slate-800 text-gray-700 dark:text-slate-300 border border-gray-200 dark:border-slate-700 rounded-2xl font-bold text-lg hover:bg-gray-50 dark:hover:bg-slate-700 transition"
            >
              View Dashboard
            </Link>
          </div>
        ...
        <section id="features" className="bg-gray-50 dark:bg-slate-900/50 py-16 transition-colors duration-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold mb-4 text-slate-900 dark:text-slate-100">Why choose AceMock AI?</h2>
              <p className="text-gray-500 dark:text-slate-400">Built for high-stakes career moves</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div key={i} className="bg-white dark:bg-slate-800 p-8 rounded-3xl border border-gray-100 dark:border-slate-700 hover:shadow-xl dark:hover:shadow-slate-950/50 transition-all">
                  <div className="text-4xl mb-4">{f.icon}</div>
                  <h3 className="text-xl font-bold mb-2 text-slate-900 dark:text-slate-100">{f.title}</h3>
                  <p className="text-gray-500 dark:text-slate-400">{f.desc}</p>
                </div>
              ))}
            </div>
          </div>
